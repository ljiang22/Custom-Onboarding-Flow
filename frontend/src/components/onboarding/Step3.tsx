...
export default function Step3({ user, config, onComplete, onPrevious, isSubmitting }: Step3Props) {
  ...
  const sortedComponents = [...config.page3Components].sort((a, b) => a.order - b.order);
